...
The open-source alpha is publishable. Aegify has executable multi-repository and
monorepo identity, cross-repository reachability, JVM and Spring semantic models,
frontend/Gateway/backend/runtime attack-surface correlation, a normalized rule
contract, external evidence adapters, and policy-controlled verification.
...
|---|---:|---|
| Scanner regression | Pass | 298 passed, 1 skipped; 77% coverage |
| Python quality | Pass | Ruff and strict mypy across 74 source files |
...
| Dashboard | Pass | 7 tests, ESLint, TypeScript/Next production build |
...
Detailed evidence is in [Alpha Completion Audit](docs/ALPHA_COMPLETION_AUDIT.md),
[Technical Architecture](docs/TECHNICAL_ARCHITECTURE.md), and
