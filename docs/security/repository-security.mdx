...
The supply-chain policy check rejects mutable GitHub Action tags, unpinned
container base images, npm registry packages without SHA-512 integrity, and
Python registry artifacts without SHA-256 hashes.
