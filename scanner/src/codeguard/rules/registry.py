...
from codeguard.rules.base import RuleRegistry, get_registry
...
def load_builtin_rules() -> RuleRegistry:
    ...
    """
    import codeguard.rules.command_injection  # noqa: F401
    import codeguard.rules.idor  # noqa: F401
    import codeguard.rules.path_traversal  # noqa: F401
    import codeguard.rules.sql_injection  # noqa: F401
    import codeguard.rules.xss  # noqa: F401
...
def load_custom_rules(path: str | Path) -> int:
    ...
    """
    from codeguard.rules.yaml_rule import load_and_register_yaml_rules
...
def _load_bundled_yaml_rules() -> int:
    ...
    Resolution order:
    1. Bundled rules inside installed package (codeguard/bundled_rules/)
