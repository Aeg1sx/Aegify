...
from codeguard.models import Finding, ScanResult, Severity, TokenUsage
...
class GitHubReporter:
    ...
    def generate_comment(self, scan_result: ScanResult) -> str:
        ...
        lines: list[str] = []
        lines.append("## 🔒 CodeGuard SAST Results\n")
...
PR_COMMENT_MARKER = "<!-- codeguard-pr-comment -->"
...
def generate_pr_comment(
    ...
    if not findings:
        lines.append("## :white_check_mark: CodeGuard SAST — No Issues Found\n")
    ...
    lines.append("## :lock: CodeGuard SAST — PR Scan Results\n")
