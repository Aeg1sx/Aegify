...
from codeguard.models import Finding, ScanResult, Severity
...
class SARIFReporter:
        ...
        run: dict[str, Any] = {
            "tool": {
                "driver": {
                    ...
                    "informationUri": "https://github.com/codeguard/sast",
                    "rules": rules,
                }
            },
            "results": results,
    ...
    def _get_taint_config(self) -> Any:
        ...
        if not hasattr(self, "_taint_config"):
            from codeguard.scanner.dataflow import TaintConfig
